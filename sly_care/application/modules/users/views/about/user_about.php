					...
					<div class="col-lg-12">
						<div class="row merged20" id="page-contents">
							<div class="user-profile">
								<figure>
									<img src="<?=img_url('resources/profile-image.jpg')?>" alt="">
										...
										<div class="col-lg-2 col-md-3">
											<div class="profile-author">
												<a class="profile-author-thumb" href="about.html">
													<img alt="author" src="<?=img_url('resources/author.jpg')?>">
												</a>
							...
							<div class="col-lg-4 col-md-4">
								<div class="central-meta stick-widget">
									...
									<div class="personal-head">
										...
										<p>
											<a href="wpkixx.html" title="">www.wpkixx.com</a> <a href="http://wpkixx.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="2e7e475a4047456e57415b5c434f4742004d4143">[email&#160;protected]</a> 
										</p>
							...
							<div class="col-lg-8 col-md-8">
									...
									<div class="row">
										...
										<div class="col-lg-6">
											<div class="gen-metabox no-margin">
												...
												<ul class="badged">
													<li><img src="<?=img_url('badges/badge2.png')?>" alt=""></li>
													<li><img src="<?=img_url('badges/badge19.png')?>" alt=""></li>
													<li><img src="<?=img_url('badges/badge21.png')?>" alt=""></li>
													<li><img src="<?=img_url('badges/badge3.png')?>" alt=""></li>
													<li><img src="<?=img_url('badges/badge4.png')?>" alt=""></li>
												</ul>
											</div>
										</div>
									</div>	
								...
								<div class="central-meta">
									...
									<div class="row">
										<div class="col-lg-4 col-md-6 col-sm-6">
											<div class="fav-play">
												<figure>
													<img src="<?=img_url('resources/tvplay1.jpg')?>" alt="">
												</figure>	
										...
										<div class="col-lg-4 col-md-6 col-sm-6">
											<div class="fav-play">
												<figure>
													<img src="<?=img_url('resources/tvplay2.jpg')?>" alt="">
												</figure>	
										...
										<div class="col-lg-4 col-md-6 col-sm-6">
											<div class="fav-play">
												<figure>
													<img src="<?=img_url('resources/tvplay3.jpg')?>" alt="">
												</figure>	
								...
								<div class="central-meta">
									...
									<ul class="frndz-list">
										<li>
											<img src="<?=img_url('resources/recent1.jpg')?>" alt="">
										...
										<li>
											<img src="<?=img_url('resources/recent2.jpg')?>" alt="">
											<div class="sugtd-frnd-meta">
										...
										<li>
											<img src="<?=img_url('resources/recent3.jpg')?>" alt="">
											<div class="sugtd-frnd-meta">
										...
										<li>
											<img src="<?=img_url('resources/recent4.jpg')?>" alt="">
											<div class="sugtd-frnd-meta">
										...
										<li>
											<img src="<?=img_url('resources/recent5.jpg')?>" alt="">
											<div class="sugtd-frnd-meta">
										...
										<li>
											<img src="<?=img_url('resources/recent6.jpg')?>" alt="">
											<div class="sugtd-frnd-meta">
												<a href="#" title="">Amelia</a>
								...
								<div class="central-meta">
									...
									<ul class="photos-list">
										<li>
											<div class="item-box">
												<a class="strip" href="<?=img_url('resources/photo-22.jpg')?>" title="" data-strip-group="mygroup" data-strip-group-options="loop: false">
												<img src="<?=img_url('resources/photo2.jpg')?>" alt=""></a>
										...
										<li>
											<div class="item-box">
												<a class="strip" href="<?=img_url('resources/photo-33.jpg')?>" title="" data-strip-group="mygroup" data-strip-group-options="loop: false">
												<img src="<?=img_url('resources/photo3.jpg')?>" alt=""></a>
												<div class="over-photo">
										...
										<li>
											<div class="item-box">
												<a class="strip" href="<?=img_url('resources/photo-44.jpg')?>" title="" data-strip-group="mygroup" data-strip-group-options="loop: false">
												<img src="<?=img_url('resources/photo4.jpg')?>" alt=""></a>
												<div class="over-photo">
										...
										<li>
											<div class="item-box">
												<a class="strip" href="<?=img_url('resources/photo-55.jpg')?>" title="" data-strip-group="mygroup" data-strip-group-options="loop: false">
												<img src="<?=img_url('resources/photo5.jpg')?>" alt=""></a>
												<div class="over-photo">
										...
										<li>
											<div class="item-box">
												<a class="strip" href="<?=img_url('resources/photo-66.jpg')?>" title="" data-strip-group="mygroup" data-strip-group-options="loop: false">
												<img src="<?=img_url('resources/photo6.jpg')?>" alt=""></a>
												<div class="over-photo">
										...
										<li>
											<div class="item-box">
												<a class="strip" href="<?=img_url('resources/photo-77.jpg')?>" title="" data-strip-group="mygroup" data-strip-group-options="loop: false">
												<img src="<?=img_url('resources/photo7.jpg')?>" alt=""></a>
												<div class="over-photo">
										...
										<li>
											<div class="item-box">
												<a class="strip" href="<?=img_url('resources/photo-88.jpg')?>" title="" data-strip-group="mygroup" data-strip-group-options="loop: false">
												<img src="<?=img_url('resources/photo8.jpg')?>" alt=""></a>
												<div class="over-photo">
								...
								<div class="central-meta">
									...
									<ul class="videos-list">
										<li>
											<div class="item-box">
												<a href="https://www.youtube.com/watch?v=fF382gwEnG8&amp;t=1s" title="" data-strip-group="mygroup" class="strip" data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img src="<?=img_url('resources/vid-11.jpg')?>" alt="">
												<i>
										...
										<li>
											<div class="item-box">
												<a href="https://www.youtube.com/watch?v=fF382gwEnG8&amp;t=1s" title="" data-strip-group="mygroup" class="strip" data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img src="<?=img_url('resources/vid-12.jpg')?>" alt="">
												<i>
													<svg version="1.1" class="play" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="50px" width="50px"
													 viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
													  <path class="stroke-solid" fill="none" stroke=""  d="M49.9,2.5C23.6,2.8,2.1,24.4,2.5,50.4C2.9,76.5,24.7,98,50.3,97.5c26.4-0.6,47.4-21.8,47.2-47.7
										...
										<li>
											<div class="item-box">
												<a href="https://www.youtube.com/watch?v=fF382gwEnG8&amp;t=1s" title="" data-strip-group="mygroup" class="strip" data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img src="<?=img_url('resources/vid-10.jpg')?>" alt="">
													<i>
														<svg version="1.1" class="play" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="50px" width="50px"
														 viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
													  <path class="stroke-solid" fill="none" stroke=""  d="M49.9,2.5C23.6,2.8,2.1,24.4,2.5,50.4C2.9,76.5,24.7,98,50.3,97.5c26.4-0.6,47.4-21.8,47.2-47.7
										...
										<li>
											<div class="item-box">
												<a href="https://www.youtube.com/watch?v=fF382gwEnG8&amp;t=1s" title="" data-strip-group="mygroup" class="strip" data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img src="<?=img_url('resources/vid-9.jpg')?>" alt="">
													<i>
														<svg version="1.1" class="play" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="50px" width="50px"
														 viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
													  <path class="stroke-solid" fill="none" stroke=""  d="M49.9,2.5C23.6,2.8,2.1,24.4,2.5,50.4C2.9,76.5,24.7,98,50.3,97.5c26.4-0.6,47.4-21.8,47.2-47.7
										...
										<li>
											<div class="item-box">
												<a href="https://www.youtube.com/watch?v=fF382gwEnG8&amp;t=1s" title="" data-strip-group="mygroup" class="strip" data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img src="<?=img_url('resources/vid-6.jpg')?>" alt="">
													<i>
														<svg version="1.1" class="play" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="50px" width="50px"
														 viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
													  <path class="stroke-solid" fill="none" stroke=""  d="M49.9,2.5C23.6,2.8,2.1,24.4,2.5,50.4C2.9,76.5,24.7,98,50.3,97.5c26.4-0.6,47.4-21.8,47.2-47.7
