...
<div class="bottombar">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4">
				<span class="copyright" style="color: black;">©SlyCare 2020. Tout droit reserver.</span>
	...
	<div class="popup post-sharing">
		...
		<div class="popup-meta">
			...
			<div class="postbox">
				...
				<figure><img src="<?=img_url('resources/share-post.jpg')?>" alt=""></figure>
				<div class="friend-info">
					<figure>
						<img alt="" src="<?=img_url('resources/admin.jpg')?>">
					</figure>
