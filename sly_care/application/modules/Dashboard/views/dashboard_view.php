    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center">
          ...
          <div class="title">
            <h1 class="h5" style=""><?= $this->session->userdata('USER_NAME')." ".$this->session->userdata('USER_POST_NOM');  ?></h1>
            <p>Domaine</p>
          </div>
        </div>
        <!-- Sidebar Navidation Menus--><span class="heading">Main</span>
        <ul class="list-unstyled">
                <li class="active"><a href="<?= base_url('Dashboard/dashboard') ?>"> <i class="icon-home"></i>Home </a></li>
                <li><a href="tables.html"> <i class="icon-grid"></i>Tables </a></li>
                <li><a href="<?= base_url('Communication/Communication/chat') ?>"> <i class="fa fa-bar-chart"></i>Chat </a></li>
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="<?= base_url(); ?>assets/templates/img/avatar-1.jpg" alt="..." class="img-fluid">
              ...
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="<?= base_url(); ?>assets/templates/img/avatar-4.jpg" alt="..." class="img-fluid">
              ...
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="<?= base_url(); ?>assets/templates/img/avatar-6.jpg" alt="..." class="img-fluid">
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="<?= base_url(); ?>assets/templates/img/avatar-1.jpg" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Tomas Hecktor</strong><span class="d-block">@tomhecktor</span></a>
                </div>
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="<?= base_url(); ?>assets/templates/img/avatar-2.jpg" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Alexander Shelby</strong><span class="d-block">@alexshelby</span></a>
                </div>
                <div class="col-lg-4 text-center">
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="<?= base_url(); ?>assets/templates/img/avatar-6.jpg" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Arther Kooper</strong><span class="d-block">@artherkooper</span></a>
                </div>
                <div class="col-lg-4 text-center">
              ...
              <!--mESSAGE -->                                           
                <div class="messages-block block">
                  ...
                  <div class="messages"><a href="#" class="message d-flex align-items-center">
                      <div class="profile"><img src="<?= base_url(); ?>assets/templates/img/avatar-3.jpg" alt="..." class="img-fluid">
                      ...
                      <div class="profile"><img src="<?= base_url(); ?>assets/templates/img/avatar-2.jpg" alt="..." class="img-fluid">
                      ...
                      <div class="profile"><img src="<?= base_url(); ?>assets/templates/img/avatar-1.jpg" alt="..." class="img-fluid">
                      ...
                      <div class="profile"><img src="<?= base_url(); ?>assets/templates/img/avatar-5.jpg" alt="..." class="img-fluid">
